...
export const ROUTE_TEACHER_SIGNUP      = '/auth/teacher/signup';
export const ROUTE_TEACHER_IS_AUTH     = '/auth/teacher/is-auth';
export const ROUTE_STUDENT_LOGIN       = '/auth/student/login';
export const ROUTE_STUDENT_ACHIEVEMENT = '/auth/student/achievement';
...
export const ROUTE_STUDENT_SLIDER      = '/auth/student/slider';
...
export const ROUTE_TEACHER_ALL_SESSION = '/session/all';

export const ROUTE_STUDENT_FLASH_SEND = '/flash/send';
